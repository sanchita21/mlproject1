...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            ## [list(model_report.values()).index(best_model_score)][0]
            ##earlier code best_model_name = list(model_report.keys())[list(model_report.values()).index(best_model_score)][0]
